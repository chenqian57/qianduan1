...
<body>
				...
				<form action="">
					...
					<dl>
						...
						<dd>
							...
							<img id="login-code" src="get_cpacha?vl=4&w=100&h=30&type=userLoginCpacha" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
	...
	<div class="footer clear wrap1000">
		<p> <a href="/OnlineShop">首页</a> |  <a href="http://programmer.ischoolbar.com">关于207商城</a> | <a href="">联系我们</a></p>
		<p>207电子商城</p>
	</div>
</body>
<script>
	function changeCode(){
		$("#login-code").attr('src','get_cpacha?vl=4&w=100&h=30&type=userLoginCpacha&t='+new Date().getTime());	
	}
