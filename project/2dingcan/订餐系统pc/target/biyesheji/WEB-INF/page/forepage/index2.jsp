                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <h1>酸菜鱼</h1>
                                    <p>欢迎品尝</p>
                                    <a href="foreDetailUI?id=43" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <h1>爆炒小龙虾</h1>
                                    <p>欢迎品尝</p>
                                    <a href="foreDetailUI?id=42" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <h1>凉拌魔芋丝</h1>
                                    <p>欢迎品尝</p>
                                    <a href="foreDetailUI?id=40" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<c:forEach end='2' items="${categories}"  var="category"  varStatus="vs">
