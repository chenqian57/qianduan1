...
<head>
    ...
    <link rel="stylesheet" href="../resources/home/css/shop_home.css" type="text/css" />
        ...
        <script type="text/javascript" src="../resources/home/js/shop_home_tab.js" ></script>
        <script type="text/javascript" src="../resources/home/js/shop_home_tab.js" ></script>
</head>

<body>
	<!-- Header  -wll-2019/12/14-->
	<div class="shop_hd">
		<!-- Header TopNav -->
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/shang">207电子商城</a></b>
						...
						<li>
							<div class="topNav_menu">
								...
								<div class="topNav_menu_bd" style="display:none;" >
						            <ul>
						              <li><a title="已买到的商品"href="../order/list">已购商品</a></li>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/shang"><img src="../resources/home/images/logo.png" alt="ShopCZ" /></a><span>207电子商城</span></h1></div>
		...
		<div class="shop_hd_menu">
			...
			<ul class="shop_hd_menu_nav">
				<li class="${currentHome }link"><a href="/shang"><span>首页</span></a></li>
				...
				<li><a href="../system/login" target="_blank">后台登录</a></li>
			</ul>
			<!-- 普通导航菜单 End -->
		</div>
		<!-- Header Menu End -->
