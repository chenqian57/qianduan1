...
<body>
	...
	<div class="main">
				...
				<form>
					...
					<dl>
						...
						<dd>
							...
							<img id="register-code" src="get_cpacha?vl=4&w=100&h=30&type=userRegisterCpacha" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
		...
		<div class="login-form-left fl">
			<dl class="func clearfix">
				<dt>注册之后您可以</dt>
				<dd class="ico03"><i></i>收藏商品</dd>
				<dd class="ico01"><i></i>购买商品</dd>
				<dd class="ico06"><i></i>评价商品</dd>
				<dd class="ico07"><i></i>诚信交易</dd>
			</dl>
	...
	<div class="footer clear wrap1000">
		<p> <a href="/OnlineShop">首页</a> |  <a href="http://programmer.ischoolbar.com">关于207电子商城</a> | <a href="">联系我们</a></p>
		<p>207电子商城</p>
	</div>
</body>
<script>
	function changeCode(){
		$("#register-code").attr('src','get_cpacha?vl=4&w=100&h=30&type=userRegisterCpacha&t='+new Date().getTime());	
	}
