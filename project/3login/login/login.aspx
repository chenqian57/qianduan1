<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="login.login" Async="true" %>
...
<div class="box">
    ...
    <div class="m-2">
          <div class="m-2-1">
            <form runat="server">
                ...
                <div class="m-2-2">
                   <asp:Button runat="server" OnClick="LoginIn" ID="Login" text="登陆" style="display:none" />
                   <input type="button" value="登陆" onclick="check()"/>
                </div>
            </form>
              <div class="m-2-2">
                   <button  value="没有账户？去注册" onclick="window.location.href='register.aspx'" /> 没有账户？去注册
                </div>
          </div>
    </div>
    <div class="m-5"> 
    ...
    <div class="m-x20"></div>  
    <div class="m-8"></div>
    <div class="m-9"><div class="masked1" id="sx8">晒科网登陆平台</div></div> 
    <div class="m-11">
...
.vaptcha-init-loading .vaptcha-text {
    ...
    <script>
        ...
        function check() {
            ...
            $.ajax({
                url: "checkLogin.aspx", data: { "username": $("#UserName").val() }, success: function (data) {
                    if (data == '0') {
                        if (!first) {
                            obj.reset();
                        }
