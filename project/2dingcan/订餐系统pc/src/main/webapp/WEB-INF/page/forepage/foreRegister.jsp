                    ...
                    <div class="login-form">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb-20">
                                <label>姓名：</label>
                                <input class="mb-0" type="text" name="name" id="name" placeholder="">
                            </div>
                            <div class="col-md-6 col-12 mb-20">
                                <label>密码：</label>
                            ...
                            <div class="col-md-12 mb-20">
                                <label>地址:</label>
                                <input class="mb-0" type="text" name="address" id="address" placeholder="">
                            </div>
                            <div class="col-md-6 mb-20">
                                <label>手机:</label>
                                <input class="mb-0" type="password"  name="phone" id="phone" placeholder="">
                            </div>
