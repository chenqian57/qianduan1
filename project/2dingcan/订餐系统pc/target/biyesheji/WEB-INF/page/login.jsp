...
<head>
    ...
    <title>自助点餐后台登陆</title>

    <style type="text/css">
        *{padding:0px;margin:0px;}
        body{font-family:Arial, Helvetica, sans-serif;background:url(../../images/beijing.jpg);font-size:12px;}
        img{border:0;}
        .lg{width:468px;height:468px;margin:100px auto;background:url(../../images/yuanxing.jpg) no-repeat;}
